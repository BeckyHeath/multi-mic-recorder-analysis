...
fn_1 = "noplastic";
fn_2 = "sample.inplastic";

% Load in Audio
samples = [1,10*44000]; % Sweeps are just the first 10 seconds
...
subplot(2,5,[4,5]);
spectrogram(a1,1280,1200,1280,48000,'yaxis')
title(desc1)

subplot(2,5,[9,10]);
spectrogram(a2,1280,1200,1280,48000,'yaxis')
title(desc2)
